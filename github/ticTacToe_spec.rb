...
describe 'TicTacToe' do
  ...
  it 'Expect make_board to return an array' do
    expect(@game.make_board).to be_a_kind_of(Array) 
  end

  it 'Expect the array to be a 2D array with 3 arrays inside of the main array' do
    expect(@game.make_board.length).to eq(3)
   ...
   it 'Expect the inside arrays to have the numbers 1 through 9 as strings' do
